...
#' Geomasking goals:
#' \itemize{
#'   \item simplify and standardize the process
...
#' }
#'
# To run the default version of of the geomasker, follow the
# \href{../doc/tutorial.html}{Walkthrough} in the vignettes.
#
# For information about how the geomasker works, check out the
# \href{../doc/tech_notes.html}{technical notes}.
#'
#' The geomasker was made possible through funding made available to the New
#' York State Department of Health / HRI by the CDC through
#' grant # NUE1EH001341-03-01.
