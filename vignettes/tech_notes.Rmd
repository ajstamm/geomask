...
This package is maintained by the New York State Department of Health (NYSDOH) Environmental Public Health Tracking (EPHT) program. The purpose of the geomasker is to move points randomly within a circular region around each point. This could be used to preserve confidentiality in publicly released point maps.
